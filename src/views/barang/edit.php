    ...
    <div class="container col-50">
        ...
        <form id="form" action="<?= BASEURL; ?>/barang/edit_barang" method="post">
            ...
            <div class="row">
                ...
                <div class="col-75">
                    <button onclick="edit('update')" type="button" class="btn primary"><i class="fa-solid fa-pen-to-square"></i> Edit</button>
                    <button onclick="edit('delete')" type="button" class="btn danger"><i class="fa-solid fa-trash"></i> Delete</button>
                </div>
            </div>
        </form>
    </div>
